...
export const EVENT_TYPES_TO_FETCH = [
  ...
  `${NEXT_PUBLIC_DAO_CONTRACT_ADDRESS}::witness::LateQuorumExtended`,
  `${NEXT_PUBLIC_DAO_CONTRACT_ADDRESS}::legacy::RebaseCompounded`,
  `${NEXT_PUBLIC_DAO_CONTRACT_ADDRESS}::restore::BribeRolledOver`,
